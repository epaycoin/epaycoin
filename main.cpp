...
unsigned int nStakeMinAge = 60 * 60 *  8  * 9999;	
unsigned int nStakeMaxAge = 60 * 60 * 24 * 9999;
unsigned int nStakeTargetSpacing = 60;			

int64 nChainStartTime = 1462601604;
...
const string strMessageMagic = "EasyPayCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nPoWHeight == 1)
       nSubsidy = 210000000 * COIN; //Premin: 100M
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    int64 nSubsidy = nCoinAge * nRewardCoinYear / 365;  //1%
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in EasyPayCoin
    bool fStrictPayToScriptHash = true; // Always active in EasyPayCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EasyPayCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = " Apr 23 2016. nothing to say. EasyPayCoin. lwlala";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x741536e314583bff4011ec21ddc032753b595c241c54b7355106754a7504293d"));
...
unsigned char pchMessageStart[4] = { 0x19, 0x26, 0x10, 0x04 };
